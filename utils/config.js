...
const mongoURI = process.env.MONGODB_URI || `mongodb+srv://${dbConfig.user}:${dbConfig.password}@capstone-2.s3zi0zl.mongodb.net/${dbConfig.database}?retryWrites=true&w=majority`
